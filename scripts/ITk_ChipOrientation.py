...
class ChipOrientation(QDialog):
    ...
    def paintEvent(self,event):
        ...
        painter.drawEllipse(310,334,50,50)
            # Insert the text
        painter.drawText(QRectF(139,104,50,50),Qt.AlignCenter,"GA4")
        painter.drawText(QRectF(310,104,50,50),Qt.AlignCenter,"GA1")
        painter.drawText(QRectF(139,334,50,50),Qt.AlignCenter,"GA3")
        painter.drawText(QRectF(310,334,50,50),Qt.AlignCenter,"GA2")
            # Assign FE hexadecimal values per chip
        font = QFont(".AppleSystemUIFont",25)
        font.setBold(True)
        painter.setFont(font)
        painter.drawText(QRectF(139,169,50,50),Qt.AlignCenter,self.hex_list[3])
        painter.drawText(QRectF(310,169,50,50),Qt.AlignCenter,self.hex_list[0])
        painter.drawText(QRectF(139,274,50,50),Qt.AlignCenter,self.hex_list[2])
        painter.drawText(QRectF(310,274,50,50),Qt.AlignCenter,self.hex_list[1])
